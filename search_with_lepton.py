...
_default_query = "What is the Vega star?"
...
class RAG(Photon):
    ...
    def query_function(
        ...
        try:
            ...
            logger.error(f"encountered error: {e}\n{traceback.format_exc()}")
            # Return a StreamingResponse with an error message
            def error_generator():
                yield "Internal server error."
            return StreamingResponse(error_generator(), media_type="text/html", status_code=503)
